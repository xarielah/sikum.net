...
const NavigationBar = () => {
  return (
    <section className="min-h-[200px] py-8 lg:py-8 bg-cyan-500 dark:bg-cyan-600 flex items-center lg:justify-between gap-6 lg:gap-0 px-16 flex-col lg:flex-row">
